...
class UserInfo extends ExecuteComand
{
	...
	public function DefineConstr()
	{
		...
		if ($_POST['Access'] == 1) 
		{
			...
			$DB = $this->DBConnect;
			$conn = $DB->GetConn();
			$QueryStr = "INSERT INTO executive_tasks.exec_list (id,idtask,employee,date, text) VALUES (DEFAULT,:task_id,:employee,:date,:text)";
			...
			try 
			{
				...
				{
					SendMessageTG($_POST['text'], $_POST['task_id'],$data[0]['text']);
				}
